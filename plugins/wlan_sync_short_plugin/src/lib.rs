...
plugin_api::export_plugin! {
    name: "SyncShort",
    description: "WLAN short preamble synchronization",
    config: (),
    create: |_cfg, _id| {
        SyncShort::<DefaultCpuReader<Complex32>, DefaultCpuReader<Complex32>, DefaultCpuReader<f32>, DefaultCpuWriter<Complex32>>::new()
    }
}
